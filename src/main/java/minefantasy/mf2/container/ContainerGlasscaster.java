...
public class ContainerGlasscaster extends Container {
    private TileEntityGlasscaster tile;


    public ContainerGlasscaster(InventoryPlayer user, TileEntityGlasscaster tile) {
        this.tile = tile;

        this.addSlotToContainer(new Slot(tile, 0, 72, 31));
        this.addSlotToContainer(new Slot(tile, 1, 72, 49));
        this.addSlotToContainer(new Slot(tile, 2, 90, 31));
        this.addSlotToContainer(new Slot(tile, 3, 90, 49));
