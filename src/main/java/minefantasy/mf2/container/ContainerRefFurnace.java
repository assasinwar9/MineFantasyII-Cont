...
public class ContainerRefFurnace extends Container {
    private TileEntityRefFurnace tile;


    public ContainerRefFurnace(InventoryPlayer user, TileEntityRefFurnace tile) {
        this.tile = tile;

        this.addSlotToContainer(new Slot(tile, 0, 85, 60));
        this.addSlotToContainer(new Slot(tile, 1, 57, 35));
        this.addSlotToContainer(new Slot(tile, 2, 85, 30));
        this.addSlotToContainer(new Slot(tile, 3, 113, 35));
