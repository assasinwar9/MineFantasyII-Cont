...
public class ContainerSoakingTrough extends Container {
    ...
    public ContainerSoakingTrough(InventoryPlayer user, TileEntitySoakingTrough tile) {
        this.tile = tile;

        this.addSlotToContainer(new Slot(tile, 0, 79, 42));
