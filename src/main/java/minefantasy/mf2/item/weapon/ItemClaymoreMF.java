...
public class ItemClaymoreMF extends ItemClaymoreStats implements IExtendedReachWeapon {
    private Random rand = new Random();

    public ItemClaymoreMF(String name, ToolMaterial material, int rarity, float weight) {
    ...
    public int getParryCooldown(DamageSource source, float dam, ItemStack weapon) {
        return claymoreParryTime + heavyParryTime;
    }

    @Override
    protected float getStaminaMod() {
        return claymoreStaminaCost * swordStaminaCost;
    }
