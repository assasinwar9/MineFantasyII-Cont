...
public class ItemGladius extends ItemGladiusStats implements IExtendedReachWeapon {
     ...
     * and parrying arc
0     */
    public ItemGladius(String name, ToolMaterial material, int rarity, float weight) {
    ...
    protected float getStaminaMod() {
        return gladiusStaminacost * swordStaminaCost;
    }
