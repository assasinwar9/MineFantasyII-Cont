...
public abstract class ItemLongswordStats extends ItemWeaponMF implements IExtendedReachWeapon {
     ...
     */
    public ItemLongswordStats(ToolMaterial material, String named, int rarity, float weight) {
    ...
    public int modifyHitTime(EntityLivingBase user, ItemStack item) {
        return super.modifyHitTime(user, item) + speedModLongsword;
    }

    @Override
    protected float[] getWeaponRatio(ItemStack implement) {
        return lsSlashingDamage;
    }
