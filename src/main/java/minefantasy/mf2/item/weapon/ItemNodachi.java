...
public class ItemNodachi extends ItemNodachiStats implements IExtendedReachWeapon {
    private Random rand = new Random();

    public ItemNodachi(String name, ToolMaterial material, int rarity, float weight) {
