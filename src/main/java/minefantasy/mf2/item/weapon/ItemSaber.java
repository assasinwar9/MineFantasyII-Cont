...
public class ItemSaber extends ItemSaberStats implements IExtendedReachWeapon {
     ...
     * and parrying arc
0     */
    public ItemSaber(String name, ToolMaterial material, int rarity, float weight) {
