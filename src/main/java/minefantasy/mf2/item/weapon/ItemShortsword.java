...
public class ItemShortsword extends ItemShortswordStats implements IExtendedReachWeapon {
     ...
     * and parrying arc
0     */
    public ItemShortsword(String name, ToolMaterial material, int rarity, float weight) {
