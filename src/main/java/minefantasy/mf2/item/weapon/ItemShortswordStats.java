...
public abstract class ItemShortswordStats extends ItemWeaponMF {
     ...
     */
    public ItemShortswordStats(ToolMaterial material, String named, int rarity, float weight) {
        super(material, named, rarity, weight);
        setMaxDamage((int) (getMaxDamage() * 0.8F));
    }
    ...
    public int modifyHitTime(EntityLivingBase user, ItemStack item) {
        return super.modifyHitTime(user, item) + speedModShortsword;
    }
