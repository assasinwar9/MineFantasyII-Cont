...
public class ItemTrident extends ItemTridentStats implements IExtendedReachWeapon {
    private Random rand = new Random();

    public ItemTrident(String name, ToolMaterial material, int rarity, float weight) {
    ...
    protected float getStaminaMod() {
        return saberStaminaCost * swordStaminaCost;
    }
