...
public abstract class ItemTridentStats extends ItemWeaponMF implements IExtendedReachWeapon{
     ...
     */
    public ItemTridentStats(ToolMaterial material, String named, int rarity, float weight) {
    ...
    public int modifyHitTime(EntityLivingBase user, ItemStack item) {
        return super.modifyHitTime(user, item) + speedModTrident;
    }

    @Override
    protected float[] getWeaponRatio(ItemStack implement) {
        return trSlashingDamage;
    }
    ...
    protected float getStaminaMod() {
        return tridentStaminaCost;
    }

    @Override
    protected float getMeleeDamage(ItemStack item) {
        return super.getMeleeDamage(item) * 1.1F;
    }
