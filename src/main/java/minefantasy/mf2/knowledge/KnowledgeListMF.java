...
public class KnowledgeListMF {
    ...
    public static IAnvilRecipe smokePipeR, framedStoneR, iframedStoneR, limestone_itemR, nailR, rivetR;
    ...
    public static IAnvilRecipe coal_fluxR, encrustedR, steelR, obsidianHunkR, diamondR;
